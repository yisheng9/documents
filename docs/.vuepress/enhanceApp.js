  ...
  function integrateGitment(router) {
    ...
    function renderGitment(parentEl, path) {
      ...
      const gitment = new Gitment({
        ...
        id: path,
        owner: 'yisheng9', // 必须是你自己的github账号
        repo: 'documents', // 上一个准备的github仓库
        link: location.origin + path,
        oauth: {
          client_id: '4d4249e08f528096b474', // 第一步注册 OAuth application 后获取到的 Client ID
          client_secret: 'e2415d58177883dd5f4d9d076dd12442253cd218', // 第一步注册 OAuth application 后获取到的 Clien Secret
        },
      })
